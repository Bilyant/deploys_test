...
# SECRET_KEY = 'django-insecure-m0tahgv#e@y+vvq5i#()czw1+c$3p95n=qcz6t%@*91)a0vj^@'
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv('DB_NAME', 'deploy_db'),
...
STATIC_ROOT = os.environ.get('STATIC_ROOT', BASE_DIR / 'all-static')
